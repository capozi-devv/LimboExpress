...
public class RenderFunctions {
    public static final Identifier MOOD_HAPPY = LimboExpress.id("textures/gui/mood_happy.png");
    public static final Identifier MOOD_MID = LimboExpress.id("textures/gui/mood_mid.png");
    public static final Identifier MOOD_DEPRESSIVE = LimboExpress.id("textures/gui/mood_depressive.png");
